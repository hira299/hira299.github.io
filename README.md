...
| `/case-studies` and 6 case-study pages | Professional case studies, AI engineering builds, and the Sentinel-Mesh research case study |
| `/projects` | All projects, grouped into AI engineering builds, research, and earlier builds |
| `/research` | Sentinel-Mesh, CloudFix-Bench, publications and artifacts |
...
public/         icons, images, IndexNow key file (the Open Graph image is generated by app/og-image.png)
```
